                ...
                <div id="settings-view" class="view">
                    ...
                    <div id="settings-tab-vault" class="tab-pane">
                        <div id="vault-locked-ui">
                            ...
                            <button class="btn-primary" id="btn-unlock-vault">Unlock & Sync</button>
                        </div>
                        ...
                        <label style="color:#64748b; font-weight:400; line-height:1.5; margin-top:16px;">Your profiles are securely encrypted in the browser and synced to your GitHub Gist. Zero-knowledge ensures your keys are safe.</label>
                    </div>
    ...
    renderProfilesList() {
        ...
        Object.keys(groups).forEach(provider => {
            ...
            groups[provider].forEach(p => {
                ...
                row.querySelector('.prof-activate').addEventListener('click', () => {
